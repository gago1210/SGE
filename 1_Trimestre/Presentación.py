...
print (bool (1)) #esto se hace cuando quiero convertir un numero a un valor logico como en este caso, 1.
    ...
    #4.ESTRUCTURA CONTENEDORA DE DATOS: listas = listas; diccionadios = dic;
...
print (o)
        ...
        #4.2. DICCIONARIOS (dict - {}): es una estructura que me va a dar siempre un valor consistente en una lista de parejas de variables
...
print(q, type (q)) #es heterogeneo porque podemos guardar cualquier cosa, una lista, otro diccionario, podemos anidar.
        #¿como podemos saber la cantidad de elementos que tienen? con len:
